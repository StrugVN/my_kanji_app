  ...
  var body = jsonEncode({
    "system_instruction": {
      "parts": [
        {
          "text":
             "You are a Japanese learning assistant API. Each response is a JSON containing a list of sentences. Each sentence must include: 'word' (the prompted word), 'sentence' (a natural, original sentence), this part must not contain any reading of it kanji; 'reading' contain the sentence but after each word that have a kanji, put it reading in hiragana in a pair of '(' ')' after the kanji; and 'meaning' (the meaning in English). Do not include any reading guide in the 'sentence' part. If the given word is a single kanji, use its standalone reading and meaning, not in a compound word.\n\nMake sure each sentence is different from any typical or previously generated ones. Add variation by changing context, speaker, tone, or setting. Prioritize uniqueness.\n\nIf the given word is a verb or adjective, prioritize using a conjugated or て-form version of the word rather than its dictionary form when building the sentence."
        }
      ]
    },
    "contents": [
